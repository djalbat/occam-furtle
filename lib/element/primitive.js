...
var _default = (0, _elements.define)((_Primitive = /*#__PURE__*/ function(Element) {
    ...
    return Primitive;
}(_wrap_native_super(_occamlanguages.Element)), _define_property(_Primitive, "name", "Primitive"), _Primitive));
